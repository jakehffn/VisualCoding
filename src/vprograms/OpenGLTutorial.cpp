...
void OpenGLTutorial::init(SDL_Window* window) {
    ...
    std::string vertexPath = "./src/shaderPrograms/TutorialShader/vertexShader.glsl";
    std::string fragmentPath = "./src/shaderPrograms/TutorialShader/fragmentShader.glsl";
